...
from src.data import VideoClassificationDataModule
from src.model import VideoClassificationModel
...
# Temp fix for https://github.com/Lightning-AI/lightning/issues/17168
os.rename(
